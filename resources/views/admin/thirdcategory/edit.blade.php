...
<div class="row bread_part">
    <div class="col-sm-12 bread_col">
        <h4 class="pull-left page-title bread_title">Update Third Category</h4>
        <ol class="breadcrumb pull-right">
            <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
            <li class="active">Update Third Category</li>
        </ol>
    </div>
</div>
...
<div class="row">
    {{-- form part --}}
    <div class="col-lg-12">
      <form class="form-horizontal" id="categoryFrom" method="post" action="{{ route('thirdcategory.update') }}" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-8">
                        <h3 class="card-title card_top_title"><i class="fab fa-gg-circle"></i> Edit Third Category</h3>
                    </div>
            ...
            <div class="card-body card_form">
              ...
              <div class="form-group row custom_form_group{{ $errors->has('subcategory_id') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-7">
                    <select class="form-control" name="subcategory_id" required data-parsley-trigger="keyup">
                      ...
                      <option value="{{ $data->subcategory->id }}" {{ $data->subcategory_id != "" ? 'selected' : '' }}>{{ $data->subcategory->subcategory_name }}</option>
              ...
              <div class="form-group row custom_form_group{{ $errors->has('thirdcategory_name') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-7">
                    <input type="text" placeholder="Input Third Category Name" class="form-control" name="thirdcategory_name" value="{{ $data->thirdcategory_name }}" required data-parsley-trigger="keyup">
