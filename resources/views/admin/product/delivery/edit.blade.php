...
<div class="row bread_part">
    <div class="col-sm-12 bread_col">
        <h4 class="pull-left page-title bread_title">Edit Delivery information</h4>
        <ol class="breadcrumb pull-right">
            <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
            <li class="active">Edit Delivery information</li>
        </ol>
    </div>
</div>
...
<div class="row">
    {{-- form part --}}
    <div class="col-lg-12">
      <form class="form-horizontal" id="brandFrom" method="post" action="{{ route('pdelivery.update',$data->id) }}" enctype="multipart/form-data">
        @csrf
        @method('put')
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-8">
                        <h3 class="card-title card_top_title"><i class="fab fa-gg-circle"></i> Edit Delivery information</h3>
                    </div>
            ...
            <div class="card-body card_form">
              ...
              <div class="form-group row custom_form_group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" placeholder="Input Title" class="form-control" name="title" value="{{ $data->title }}" required>
                  </div>
              </div>
              ...
              <div class="form-group row custom_form_group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" placeholder="Input Content" class="form-control" name="content" value="{{ $data->content }}">
                  </div>
              </div>
