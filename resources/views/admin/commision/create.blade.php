...
@section('content')
  ...
  <div class="row">
    <div class="col-lg-12">
        <form class="form-horizontal" method="post" action="{{ route('commision.store') }}" enctype="multipart/form-data" id="customerForm">
          @csrf
          ...
          <div class="card">
            <div class="card-header custom-card-header">
                <div class="row">
                    <div class="col-md-8">
                        <h3 class="card-title card_top_title"><i class="fab fa-gg-circle"></i> Commision Payment For Employee</h3>
                    </div>
            ...
            <div class="card-body card_form">
              ...
              <div class="form-group custom_form_group row">
                  ...
                  <div class="col-md-5">
                        <input type="text" placeholder="Amount" class="form-control" name="commision_amount" value="{{ old('commision_amount') }}" required data-parsley-pattern="[0-9]+$" min="0" data-parsley-length="[1,7]" data-parsley-trigger="keyup">
              ...
              <div class="form-group custom_form_group row">
                  ...
                  <div class="col-md-5">
                        ...
                        <textarea class="form-control" name="remarks" rows="4" cols="80" required placeholder="Commision Reason...">{{ old('remarks') }}</textarea>
