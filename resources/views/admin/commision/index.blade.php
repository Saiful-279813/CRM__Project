            ...
            <div class="card-header custom-card-header">
                <div class="row">
                    ...
                    <div class="col-md-4 text-right">
                        <a href="{{ route('commision.create') }}" class="btn btn-md btn-primary waves-effect card_top_button"><i class="fa fa-plus-circle mr-2"></i>Commision Payment For Employee</a>
                    </div>
                            ...
                            <table id="alltableinfo" class="table table-bordered custom_table mb-0">
                                ...
                                <tbody>
                                   ...
                                   <tr>
                                     ...
                                     <td style="width:17%">
                                        @if($data->status == 0)
                                          <a class="btn btn-primary btn-sm" href="{{ route('commision.edit',$data->id) }}" ><i class="fas fa-edit"></i></a>
