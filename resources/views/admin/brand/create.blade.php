...
<div class="row bread_part">
    <div class="col-sm-12 bread_col">
        <h4 class="pull-left page-title bread_title">Add New Brand</h4>
    ...
    <div class="col-md-8">
        @if(Session::has('success_store'))
          <div class="alert alert-success alertsuccess" role="alert">
             <strong>Successfully!</strong> Added New Brand.
          </div>
        @endif
...
<div class="row">
    {{-- form part --}}
    <div class="col-lg-12">
      <form class="form-horizontal" id="brandFrom" method="post" action="{{ route('brand.store') }}" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-8">
                        <h3 class="card-title card_top_title"><i class="fab fa-gg-circle"></i> Add New Brand</h3>
                    </div>
            ...
            <div class="card-body card_form">
              ...
              <div class="form-group row custom_form_group{{ $errors->has('brand_name') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-7">
                    <input type="text" placeholder="Input Brand Name" class="form-control" name="brand_name" value="{{old('brand_name')}}" required data-parsley-trigger="keyup">
