                  ...
                  <div class="col-md-6">
                      ...
                      <div class="card-body card_form">
                          ...
                          <div class="form-group custom_form_group">
                              ...
                              <div class="">
                                  <input type="text" placeholder="Name" class="form-control" name="customer_name" value="{{old('customer_name')}}" required data-parsley-pattern="[a-zA-Z]+$" data-parsley-length="[3,50]" data-parsley-trigger="keyup">
                                  @error('customer_name')
                          ...
                          <div class="form-group custom_form_group">
                              ...
                              <div class="">
                                  <input type="text" placeholder="Father Name" class="form-control" name="customer_father" value="{{old('customer_father')}}" required data-parsley-pattern="[a-zA-Z]+$" data-parsley-length="[3,50]" data-parsley-trigger="keyup">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="card-body card_form">
                        ...
                        <div class="form-group custom_form_group">
                            ...
                            <div class="">
                              <input type="text" placeholder="Visa Type" class="form-control" name="visa_name" value="{{old('visa_name')}}" required data-parsley-pattern="[a-zA-Z0-9]+$" data-parsley-length="[3,50]" data-parsley-trigger="keyup">
                              @error('visa_name')
                                  <span class="text-danger">{{ $message }}</span>
                              @enderror
                            </div>
